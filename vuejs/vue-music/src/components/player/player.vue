<template>
    <div class="player" v-show="playlist.length">
                    ...
                    <scroll class="middle-r" ref="lyricList" :data="currentLyric && currentLyric.lines">
                        <div class="lyric-wrapper">
                            <div v-if="currentLyric">
                                <p v-for="(line,index) in currentLyric.lines" :key="line" class="text" :class="{'current': currentLineNum ===index}"
        ...
        <audio :src="currentSong.url" @play="ready" @error="error" @timeupdate="timeUpdate" @ended="end"
            ref="audio"></audio>
    </div>
</template>
